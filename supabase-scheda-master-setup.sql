...
-- non si caricano le foto vere), note libere, contratto allegato, e i
-- corsi a cui è associata con la propria fascia di compenso per numero
-- di allievi (es. 1-2 allievi: 300€, 3-5: 350€, 6+: 400€).
--
